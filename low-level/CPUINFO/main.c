...
inline unsigned int cpuid_ecx(unsigned int eax_p, unsigned int ebx_p, unsigned int ecx_p, unsigned int edx_p) {
	register unsigned int eax asm("eax");
	register unsigned int ebx asm("ebx");
	register unsigned int ecx asm("ecx");
	register unsigned int edx asm("edx");
...
inline unsigned int  cpuid_edx(unsigned int eax_p, unsigned int ebx_p, unsigned int ecx_p, unsigned int edx_p) {
	register unsigned int eax asm("eax");
	register unsigned int ebx asm("ebx");
	register unsigned int ecx asm("ecx");
	register unsigned int edx asm("edx");
...
void print_processor_features_support() {
	...
	print_binary(cpuid_ecx(1,0,0,0));
	print_binary(cpuid_edx(1,0,0,0));
